...
internal static partial class WasmRailBridge
{
    ...
    // Sprite smoothing (texel-AA, operator goal 2026-07-10): same profile
    // fields as the in-game options; persists via the profile sync.
    [JSExport]
    ...
    // ── LegionScript API completion (2026-07-24) ─────────────────────────────
    [JSExport]
    ...
    [JSExport]
    internal static Task<bool> BandageSelf()
    {
        return Task.FromResult(ClassicUO.Game.RailBridgeApi.BandageSelf());
    }
    ...
    [JSExport]
    internal static Task<bool> IsGlobalCooldownActive()
    {
        return Task.FromResult(ClassicUO.Game.RailBridgeApi.IsGlobalCooldownActive());
    }
    ...
    [JSExport]
    internal static Task DisplayRange(int distance, int hue)
    {
        ClassicUO.Game.RailBridgeApi.DisplayRange(distance, hue);
        return Task.CompletedTask;
    }
    ...
    {
        ClassicUO.Game.RailBridgeApi.Logout();
        return Task.CompletedTask;
    }
    ...
    [JSExport]
    internal static Task SetMount(double serial)
    {
        ClassicUO.Game.RailBridgeApi.SetMount(serial);
        return Task.CompletedTask;
    }
    ...
    [JSExport]
    internal static Task ClearMoveQueue()
    {
        ClassicUO.Game.RailBridgeApi.ClearMoveQueue();
        return Task.CompletedTask;
    }

    [JSExport]
    internal static Task<bool> IsProcessingMoveQueue()
    {
        return Task.FromResult(ClassicUO.Game.RailBridgeApi.IsProcessingMoveQueue());
    }

    [JSExport]
    internal static Task<bool> IsProcessingUseItemQueue()
    {
        return Task.FromResult(ClassicUO.Game.RailBridgeApi.IsProcessingUseItemQueue());
    }
    ...
    [JSExport]
    internal static Task<bool> CloseGump(double id)
    {
        return Task.FromResult(ClassicUO.Game.RailBridgeApi.CloseGump(id));
    }

    [JSExport]
    internal static Task<bool> GumpContains(string text, double id)
    {
        return Task.FromResult(ClassicUO.Game.RailBridgeApi.GumpContains(text, id));
    }
    ...
    [JSExport]
    internal static Task<string> GetPath(int x, int y, int z, int distance)
    {
        return Task.FromResult(ClassicUO.Game.RailBridgeApi.GetPathJson(x, y, z, distance));
    }
    ...
    [JSExport]
    internal static Task MarkTile(int x, int y, int hue, int map)
    {
        ClassicUO.Game.RailBridgeApi.MarkTile(x, y, hue, map);
        return Task.CompletedTask;
    }

    [JSExport]
    internal static Task RemoveMarkedTile(int x, int y, int map)
    {
        ClassicUO.Game.RailBridgeApi.RemoveMarkedTile(x, y, map);
        return Task.CompletedTask;
    }

    [JSExport]
    internal static Task Dress(string name)
    {
        ClassicUO.Game.RailBridgeApi.Dress(name);
        return Task.CompletedTask;
    }

    [JSExport]
    internal static Task Undress(string name)
    {
        ClassicUO.Game.RailBridgeApi.Undress(name);
        return Task.CompletedTask;
    }

    [JSExport]
    internal static Task UndressAll(bool kr)
    {
        ClassicUO.Game.RailBridgeApi.UndressAll(kr);
        return Task.CompletedTask;
    }

    [JSExport]
    internal static Task<string> GetAvailableDressOutfits()
    {
        return Task.FromResult(ClassicUO.Game.RailBridgeApi.GetAvailableDressOutfitsJson());
    }

    [JSExport]
    internal static Task ToggleAutoLoot()
    {
        ClassicUO.Game.RailBridgeApi.ToggleAutoLoot();
        return Task.CompletedTask;
    }

    [JSExport]
    internal static Task AutoLootContainer(double container)
    {
        ClassicUO.Game.RailBridgeApi.AutoLootContainer(container);
        return Task.CompletedTask;
    }

    [JSExport]
    internal static Task AutoFollow(double mobile)
    {
        ClassicUO.Game.RailBridgeApi.AutoFollow(mobile);
        return Task.CompletedTask;
    }

    [JSExport]
    internal static Task CancelAutoFollow()
    {
        ClassicUO.Game.RailBridgeApi.CancelAutoFollow();
        return Task.CompletedTask;
    }
    ...
    [JSExport]
    internal static Task TargetResource(double itemSerial, int resource)
    {
        ClassicUO.Game.RailBridgeApi.TargetResource(itemSerial, resource);
        return Task.CompletedTask;
    }
