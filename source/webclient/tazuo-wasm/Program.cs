...
// -reconnect (operator 2026-07-07 "el -reconnect nativo de cuo y tuo"): enable TazUO's native
...
// with saved credentials, re-logs-in (native Reconnect behaviour). Passed as an ARG (not
