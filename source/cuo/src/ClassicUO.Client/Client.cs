...
namespace ClassicUO
{
    ...
    internal static class Client
    {
        ...
        {
#if BROWSER_WASM
            // Browser has no native message-box equivalent and SDL3 isn't
            // linked into our WASM build. Route error text to the devtools
            // console instead — the user's "error dialog" is the log.
            WasmTrace.W($"[CUO ERROR] {msg}");
#else
