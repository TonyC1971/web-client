    ...
    internal class InfoBarControl : Control
    {
        ...
        public override bool AddToRenderLists(RenderLists renderLists, int x, int y, ref float layerDepthRef)
        {
            ...
            if (Var != InfoBarVars.NameNotoriety && ProfileManager.CurrentProfile.InfoBarHighlightType == 1 && _warningLinesHue != 0x0481)
            {
                ...
                // Capture Parent.Height at ENQUEUE time, not inside
                // the closure — Parent can be null or reparented
                // between enqueue and draw under wasm's per-gump
                // render + AnchorableGump docking. Bug O35.
                int capturedParentHeight = Parent?.Height ?? 0;
                ...
                renderLists.AddGumpNoAtlas(
                    batcher =>
                    {
                        ...
                        (
                            ...
                            (
                                _data.ScreenCoordinateX,
                                _data.ScreenCoordinateY + capturedParentHeight - 2,
                                _data.Width,
                                2
                            ),
                            hueVector,
