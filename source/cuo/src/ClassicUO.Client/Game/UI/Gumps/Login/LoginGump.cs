...
namespace ClassicUO.Game.UI.Gumps.Login
{
    internal class LoginGump : Gump
    {
        ...
        public LoginGump(World world, LoginScene scene) : base(world, 0, 0)
        {
            ...
            // Upstream ClassicUO LoginGump advertises the upstream
            // project with "Support ClassicUO!", "Website", and
            // "Join Discord" HTML links in the bottom-left corner
            // (classicuo.eu / discord.gg/VdyCpjQ). This build is a
            // WASM port for a specific ModernUO shard and those
            // external links don't belong on the login screen —
            // clicking them would drop the player into an unrelated
            // community. Per user directive 2026-04-22, removed.
            // If/when upstream convention requires re-surfacing
            // credit, a static attribution in index.html is the
            // right place, not an in-gump link.
