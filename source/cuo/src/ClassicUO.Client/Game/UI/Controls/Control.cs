...
namespace ClassicUO.Game.UI.Controls
{
    internal abstract class Control
    {
        ...
        public void InvokeDragEnd(Point position)
        {
            ...
            // Bug O2: make sure the new position survives a fast
            // reload. Gump positions are only written to disk via
            // GameController's 5 s auto-save tick; a drag + reload
            // within that window used to lose the move. Force the
            // next Update to save immediately.
