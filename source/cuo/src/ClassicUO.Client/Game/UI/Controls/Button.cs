...
namespace ClassicUO.Game.UI.Controls
{
    ...
    internal class Button : Control
    {
        ...
        public override bool AddToRenderLists(RenderLists renderLists, int x, int y, ref float layerDepthRef)
        {
            ...
            // Same atlas path trap as Checkbox (77c86bae6) and PaperDollGump
            // item render. The button's background sprite rides AddGumpWithAtlas;
            // on browser-wasm it renders as an empty region, which explains
            // the invisible TopBar icons (Actions/Inventory/Gold/Mail) even
            // though the button text beneath uses AddGumpNoAtlas and draws fine.
#if BROWSER_WASM
