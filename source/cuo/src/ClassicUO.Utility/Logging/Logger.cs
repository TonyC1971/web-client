        ...
        private void SetLogger(LogTypes type, string text)
        {
            ...
            if ((LogTypes & type) == type)
            {
                ...
                else
                {
                    ...
                    Console.Write(" | ");
                    // Browser WASM consoles don't support ConsoleColor
                    // (`Console.ForegroundColor` throws PlatformNotSupported).
                    // Skip the colour dance; the DevTools console shows
                    // everything the same color anyway.
                    ConsoleColor temp = default;
                    bool hasColor = false;
                    try { temp = Console.ForegroundColor; hasColor = true; }
