...
namespace ClassicUO.Utility
{
    public static class StringHelper
    {
        ...
        {
#if BROWSER_WASM
            // WASM: SDL's clipboard is disconnected from the browser.
            // Read the real system clipboard via the JS bridge instead.
            ...
            {
                s = multiline ? SDL.SDL_GetClipboardText() : SDL.SDL_GetClipboardText()?.Replace('\n', ' ') ?? null;
            }
#endif
