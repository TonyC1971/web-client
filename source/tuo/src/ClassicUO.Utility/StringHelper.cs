...
namespace ClassicUO.Utility
{
    public static class StringHelper
    {
        ...
        {
#if BROWSER_WASM
            // WASM: SDL's clipboard is disconnected from the browser (and the
            // P/Invoke traps in the web build). Read the real system clipboard
            // via the JS bridge instead — same guard as the cuo fork.
            {
