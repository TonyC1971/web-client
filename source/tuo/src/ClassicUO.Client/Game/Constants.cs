...
namespace ClassicUO.Game
{
    internal static class Constants
    {
        ...
        // 1000 → 60 (operator 2026-07-10 "limita todos los clientes a 60 fps max"):
        // rAF drives the browser loop anyway; higher targets only burn shared
        // main-thread time. SetRefreshRate clamps saved settings on boot and the
        // FPS slider takes its range from this constant.
